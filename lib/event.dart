...
import 'package:nandur/addEvent.dart';
import 'package:nandur/detailEvent.dart';
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: loading ? Center(child: CircularProgressIndicator(
              valueColor: AlwaysStoppedAnimation<Color>(Colors.blueGrey[500]),
            ),) : ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => detailEvent(
                          ...
                          deskripsi_event: item.data['deskripsi_event'],
                          waktu_laksana: item.data['waktu_laksana'],
                  ...
                  child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.network( item.data['gambar'],width: MediaQuery.of(context).size.width),
                          SizedBox(
                            height: 10,
                          ),
                          Text(
